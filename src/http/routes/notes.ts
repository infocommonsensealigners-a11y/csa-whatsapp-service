...
export function registerNoteRoutes(app: FastifyInstance): void {
  ...
  app.post("/intel/agent", async (req, reply) => {
    ...
    const prompt = [
      ...
      "recalcula al vuelo. Si te preguntan por algo que NO son objeciones y que exigiría releer todos los",
      "mensajes uno a uno, dilo claramente en vez de inventar: eso hay que encargarlo aparte.",
      "",
